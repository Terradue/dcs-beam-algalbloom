...
# create a folder for the input products generated by
# the previous node
mkdir -p $TMPDIR/input

# create a local folder for the results before the stage-out
...
do
  ...
  tar -C $TMPDIR/input -xzf $TMPDIR/input/`basename $prod`
done
...
tar -C $TMPDIR/output -czf $TMPDIR/output/$outputname.tgz $TMPDIR/output/$outputname.*
